    ...
    <>
      ...
      >
        <motion.div variants={itemVariants} className="flex flex-col gap-2 col-span-4">
          <Link href="/" className="focus:outline-none">
            <Image
             ...
             src={`${process.env.NEXT_PUBLIC_UPLOADED_IMAGE_URL}/${companyHeaderImage}`} className="cursor-pointer w-[200px]" alt="Footer Logo" unoptimized />
          </Link>
        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-2 col-span-2">
          ...
          <Link 
            href="/customer/pages/privacypolicy"
          ...
          <Link 
            href="/customer/pages/termsandconditions"
          ...
          <Link 
            href="/customer/pages/shippingpolicy"
          ...
          <Link 
            href="/customer/pages/returnandexchangepolicy"
